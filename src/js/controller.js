...
class Controller {
    constructor(player) {
        ...
        this.initPlayedBar();
        this.initFullButton();
        this.initPictureInPictureButton();
    ...
    initPictureInPictureButton() {
        this.player.template.pictureInpictureButton.addEventListener('click', () => {
            const video = document.getElementsByClassName("dplayer-video-current-playing")[0];
            ...
            try {
                ...
                console.log('Video failed to enter/leave Picture-in-Picture mode.');
              }
            }
            else
            {
                this.player.notice(this.player.tran('Please play the video before using Picture in Picture'));
            }
        });
    }

    initGoogleCast() {
        this.player.template.googleCast.addEventListener('click', () => {
            castNow(this.player);
